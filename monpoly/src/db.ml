...
module type DB = sig
  ...
  module Table: TABLE
  module Relation = Table.Relation
...
module MakeDb (T: TABLE) = struct

  module Table = T
  module Relation = Table.Relation
  module Tuple = Relation.Tuple

  type db = T.table list
