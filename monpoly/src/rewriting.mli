...
val check_formula: (formula -> bool * (formula * string) option) -> Db.schema -> formula -> bool * formula * (var * tcst) list
...
val check_syntax: Db.schema -> formula -> ((var * tcst) list  * formula)
