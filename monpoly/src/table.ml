...
module type TABLE = sig
  ...
  type table = schema * Relation.relation
  val make_table: schema -> Relation.relation -> table
  val get_schema: table -> schema
  val get_relation: table -> Relation.relation
...
module MakeTable (R: RELATION) = struct

  module Relation = R
  module Tuple = Relation.Tuple

  type table = schema * R.relation
